...
const spinner = ` <div class="d-flex justify-content-center aling-items-center style="height: 400px">
...
async function cagarDatosDePeliculaPorId(id) {
  try {
    ...
    const respuesta = await fetch(
      `${url_movie_detail}/${id}?api_key=${api_key}&language=${language}`
    );
